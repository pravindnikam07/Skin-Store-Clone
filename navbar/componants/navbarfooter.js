...
let navbar = () => {
    ...
    <div id="nrow2" class="n">
        <div id="hover_off" class="ndf ndp">
            ...
            <div id="nsearch">
                <input oninput="debounceFunction(main,600)" id="search_tag" type="text"> <i id="search_icon" class="fa-solid fa-magnifying-glass"></i>
    ...
    <div id="nrow3" class="n ndf">
        ...
        <div><a href="#"><i class="fa-solid fa-sack-dollar"></i> Refer a Friend, Get $15</a></div>
        <div><a href="#"><i class="fa-solid fa-piggy-bank"></i> New Customers Save 20% - Use Code NEWBIE</a></div>
        <div><a href="#"><i class="fa-solid fa-mobile"></i> Download Our App</a></div>
    </div>
                ...
                <div id="fr1c2">
                    ...
                    <div id="fm" class="fdf">
                        <div>
                            ...
                            <div><a href="#">Refer A Friend</a></div>
