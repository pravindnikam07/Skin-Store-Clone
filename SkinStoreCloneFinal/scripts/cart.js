...
function display(data){
    ...
    {   cartItems_list.innerHTML = null;
        ...
        checkOutBtn1.style.display="none"
        free_products_div.style.display="none"
        ...
        continueShopping.addEventListener('click', function () { window.location.href = './product_1.html'})
...
continueBtn.addEventListener('click', home_location);